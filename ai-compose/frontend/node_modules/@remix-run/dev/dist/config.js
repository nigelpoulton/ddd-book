...
async function resolveConfig(appConfig, {
  ...
  let future = {
    ...
    v3_singleFetch: ((_appConfig$future5 = appConfig.future) === null || _appConfig$future5 === void 0 ? void 0 : _appConfig$future5.v3_singleFetch) === true,
    v3_lazyRouteDiscovery: ((_appConfig$future6 = appConfig.future) === null || _appConfig$future6 === void 0 ? void 0 : _appConfig$future6.v3_lazyRouteDiscovery) === true,
    unstable_optimizeDeps: ((_appConfig$future7 = appConfig.future) === null || _appConfig$future7 === void 0 ? void 0 : _appConfig$future7.unstable_optimizeDeps) === true
  };
  if (appConfig.future) {
